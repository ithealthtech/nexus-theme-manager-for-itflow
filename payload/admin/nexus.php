                    ...
                    <div class="card-body">
                        <div class="tab-content">
                            <div class="tab-pane fade show active" id="nexus-brand" role="tabpanel">
                                ...
                                <div class="row mt-3">
                                    <div class="col-md-6"><div class="custom-control custom-switch"><input type="checkbox" class="custom-control-input" id="nexus-show-login-logo" name="nexus[branding][show_login_logo]" value="1" <?= $nexusSettings['branding']['show_login_logo'] ? 'checked' : '' ?>><label class="custom-control-label" for="nexus-show-login-logo">Show on authentication pages</label></div></div>
                                    <div class="col-md-6"><div class="custom-control custom-switch"><input type="checkbox" class="custom-control-input" id="nexus-show-portal-logo" name="nexus[branding][show_portal_logo]" value="1" <?= $nexusSettings['branding']['show_portal_logo'] ? 'checked' : '' ?>><label class="custom-control-label" for="nexus-show-portal-logo">Show in the client portal</label></div></div>
                                </div>
                            </div>
