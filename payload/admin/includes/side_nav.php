...
<aside class="app-sidebar shadow d-print-none" data-bs-theme="dark">
    <div class="sidebar-brand">
        <a class="brand-link nexus-admin-back" href="/agent/<?= $config_start_page ?>">
            ...
            <span class="brand-text h6 mb-0"><span>Back</span><span class="nexus-admin-back-separator" aria-hidden="true"></span><strong>Administration</strong></span>
        </a>
    </div>
    ...
    <div class="sidebar-wrapper">
        ...
        <nav>
            <ul class="nav nav-pills sidebar-menu flex-column mt-2" data-lte-toggle="treeview" data-accordion="false">
                ...
                <li class="nav-header">NEXUS</li>
                <li class="nav-item">
                    <a href="/admin/nexus.php" class="nav-link <?= (basename($_SERVER['PHP_SELF']) == 'nexus.php' ? 'active' : '') ?>">
                        <i class="nav-icon fas fa-layer-group"></i>
                        <p>
                            Theme Manager
                            <span class="right badge text-bg-info"><?= escapeHtml(NEXUS_MANAGER_VERSION) ?></span>
                        </p>
                    </a>
                </li>
