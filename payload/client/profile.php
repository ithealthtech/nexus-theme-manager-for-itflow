        ...
        <form action="post.php" method="post" autocomplete="off">
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    <input type="password" class="form-control" id="profile-password" minlength="8" required data-toggle="password" name="new_password" placeholder="Leave blank for no change" autocomplete="new-password">
                </div>
            </div>
