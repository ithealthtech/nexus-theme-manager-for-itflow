...
<!-- Close client portal main content (header.php opens <main> for the skip link) -->
</main>
...
<footer class="app-footer mt-auto py-2 text-center <?= ($nexus_theme_enabled ?? false) ? 'nexus-client-footer' : '' ?>">
    <?php
