# IT Done Right theme manager for ITFlow

[![CI](https://github.com/ithealthtech/itflow-itdoneright-theme-manager/actions/workflows/ci.yml/badge.svg)](https://github.com/ithealthtech/itflow-itdoneright-theme-manager/actions/workflows/ci.yml)
[![License: GPL v3](https://img.shields.io/badge/License-GPLv3-blue.svg)](LICENSE)
[![ITFlow compatibility](https://img.shields.io/badge/ITFlow-26.08-2f7d32.svg)](https://github.com/itflow-org/itflow)

This is a standalone lifecycle package for installing and removing the IT Done Right LLC theme without manually copying template files.
...
Download the signed-off ZIP and checksum from the [latest release](https://github.com/ithealthtech/itflow-itdoneright-theme-manager/releases/latest). GitHub's automatically generated source archives are also available, but the versioned release ZIP is the tested installation artifact.
...
2. Extract this ZIP outside the ITFlow document root, for example `/opt/itdr-theme-manager-1.0.0`.
...
State and original-file backups default to `/var/lib/itdr-itflow-theme/<instance-id>`, outside the web root. Use `--state-root PATH` consistently on every command only when the default is unsuitable.
